...
public class CardTest {
    ...
    public void testCardToString() {
        Card card = new Card(SuitType.H, 2);
        assertEquals("2" + "" + String.valueOf('\u2665'), card.toString());
        
        card = new Card(SuitType.H, 11);
        assertEquals("J" + "" + String.valueOf('\u2665'), card.toString());

        card = new Card(SuitType.H, 12);
        assertEquals("Q" + "" + String.valueOf('\u2665'), card.toString());

        card = new Card(SuitType.H, 13);
        assertEquals("K" + "" + String.valueOf('\u2665'), card.toString());

        card = new Card(SuitType.H, 1);
        assertEquals("A" + "" + String.valueOf('\u2665'), card.toString());
    }
